...
const surgerytype1= {
       ...
       susceptiblePetTypes:[{name: "dog", id:2}, {name: "cat", id:1}, {name: "snake", id:4}]
}

const surgerytype2= {   id:2, name:"Bladder surgery",
                    susceptiblePetTypes:[{
                        name: "cat", id:1
                    }, {name: "hamster", id:6}]
                }
...
export const handlers = [
    rest.get("*/api/v1/surgerytypes",(req, res, ctx) => {
        return res(
            ctx.status(200),
            ctx.json([surgerytype1,surgerytype2]),
        )
    }),
