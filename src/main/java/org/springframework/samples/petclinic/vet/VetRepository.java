...
public interface VetRepository extends CrudRepository<Vet, Integer> {
	...
	@Query("SELECT v FROM Vet v JOIN Visit vi ON v.id = vi.vet.id "
		+ "WHERE vi.datetime BETWEEN :start AND :end "
		+ "AND vi.pet.type IN :type "
		+ "GROUP BY v HAVING COUNT(vi) >= :threshold")
